...
/* Проверка более сложного графа
 * с несколькими вариантами рёбер.
 */
...
/* Проверка параллельных рёбер
 * между одинаковыми вершинами.
 */
